...
public class AtomicLongArrayHandler implements MarshalHandler<AtomicLongArray> {
	...
	@Override
	public void writeObject(OOutput out, AtomicLongArray array) throws IOException {
	...
	@Override
	public AtomicLongArray readObject(OInput in, Class<AtomicLongArray> clazz) throws IOException {
